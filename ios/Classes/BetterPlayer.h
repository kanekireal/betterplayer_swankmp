...
#import "BetterPlayerSwankmpDrmAssetsLoaderDelegate.h" // Swankmp
...
/// Swankmp
@property(readonly, nonatomic) BetterPlayerSwankmpDrmAssetsLoaderDelegate* swankmpLoaderDelegate;
